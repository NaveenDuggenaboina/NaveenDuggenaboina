...
Built a system using LDR sensors and Arduino to automatically switch street lights based on lighting conditions, improving energy efficiency.

### 🧠 Stroke Disease Detection using Machine Learning  
Applied cross-validation and feature importance analysis to identify stroke risk using medical data.
...
🔗 [![Portfolio](https://img.shields.io/badge/Visit-Portfolio-blue?style=flat-square&logo=github)](https://naveen-dark-canvas.lovable.app)
